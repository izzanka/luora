                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="input-group input-group-sm">
                                    <i class="bi bi-link-45deg mr-2" style="font-size: 20px"></i>
                                    <input type="text" name="link" class="form-control input-group-sm" placeholder="Optional: include a link source that gives context">
                                </div>
                            </div>
                        </div>
                    <hr>
