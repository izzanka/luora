                ...
                <div class="col-9">
                    ...
                    <h3 class="mt-1 text-primary">
                        @if (auth()->user()->credential == null)
                            <a href="" class="text-secondary">Add profile credential</a>
                        @else
            ...
            <div>
                ...
                <div>
                    ...
                    @if (!auth()->user()->employment()->exists())
                        <a href="" data-bs-toggle="modal" data-bs-target="#employmentModal" onclick="addEmploymentYear()">Add employment credential</a>
                    @endif
                </div>
                <div class="mt-3">
